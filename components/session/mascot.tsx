...
export function Mascot({ state }: MascotProps) {
  ...
  return (
    <div
      ...
      data-frame={frame}
      className="brand-image-glow pointer-events-none fixed bottom-3 right-3 z-30 h-20 w-20 rounded-2xl shadow-[0_18px_40px_-18px_rgba(0,0,0,0.55)] ring-1 ring-white/[0.08] sm:bottom-5 sm:right-5 sm:h-32 sm:w-32 md:h-40 md:w-40"
    >
      <Image
        key={frame}
        src={src}
